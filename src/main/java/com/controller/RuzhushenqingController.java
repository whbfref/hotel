...
public class RuzhushenqingController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,RuzhushenqingEntity ruzhushenqing, HttpServletRequest request){

		String tableName = request.getSession().getAttribute("tableName").toString();
		if(tableName.equals("yonghu")) {
			ruzhushenqing.setYonghuming((String)request.getSession().getAttribute("username"));
		}
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,RuzhushenqingEntity ruzhushenqing, HttpServletRequest request){
        EntityWrapper<RuzhushenqingEntity> ew = new EntityWrapper<RuzhushenqingEntity>();
		PageUtils page = ruzhushenqingService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, ruzhushenqing), params), params));
        return R.ok().put("data", page);
    }
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<RuzhushenqingEntity> wrapper = new EntityWrapper<RuzhushenqingEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = ruzhushenqingService.selectCount(wrapper);
