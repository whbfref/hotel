...
public class LaifangdengjiController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,LaifangdengjiEntity laifangdengji, HttpServletRequest request){

		String tableName = request.getSession().getAttribute("tableName").toString();
		if(tableName.equals("yonghu")) {
			laifangdengji.setYonghuming((String)request.getSession().getAttribute("username"));
		}
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,LaifangdengjiEntity laifangdengji, HttpServletRequest request){
        EntityWrapper<LaifangdengjiEntity> ew = new EntityWrapper<LaifangdengjiEntity>();
		PageUtils page = laifangdengjiService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, laifangdengji), params), params));
        return R.ok().put("data", page);
    }
