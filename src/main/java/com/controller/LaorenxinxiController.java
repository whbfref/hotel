...
public class LaorenxinxiController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,LaorenxinxiEntity laorenxinxi, HttpServletRequest request){

		String tableName = request.getSession().getAttribute("tableName").toString();
		if(tableName.equals("yonghu")) {
			laorenxinxi.setYonghuming((String)request.getSession().getAttribute("username"));
		}
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,LaorenxinxiEntity laorenxinxi, HttpServletRequest request){
        EntityWrapper<LaorenxinxiEntity> ew = new EntityWrapper<LaorenxinxiEntity>();
		PageUtils page = laorenxinxiService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, laorenxinxi), params), params));
        return R.ok().put("data", page);
    }
